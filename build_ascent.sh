...
anari_install_dir=$(ospath ${root_dir}/install/)
...
################
vtkm_version=master
vtkm_src_dir=$(ospath ${script_dir}/VTK-m)
...
rm -f ${camp_build_dir}/CMakeCache.txt
...
rm -f ${raja_build_dir}/CMakeCache.txt
...
rm -f ${umpire_build_dir}/CMakeCache.txt
...
rm -f ${mfem_build_dir}/CMakeCache.txt
...
rm -f ${catalyst_build_dir}/CMakeCache.txt
